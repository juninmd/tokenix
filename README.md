...
<tr>
<td><img src=".github/prints/filters.png" alt="Filters tab" /><br /><sub><b>Filters</b> — browse all 315 bundled filters by tool with a live <i>input → output</i> preview and a per-filter <code>X → Y tokens · % saved</code> gauge.</sub></td>
...
assets/
└── filters/       315 TOML output filters (+658 golden cases), embedded in the binary via rust-embed
```
